...
for ReverseLayer_latent_domain_alpha in [0.02, 0.05, 0.07, 0.1, 0.2, 0.3, 0.4]:
    for n_t in [10, 20, 30, 40, 50, 60, 70]:
        for beta_1 in [0.0001, 0.0002, 0.0004, 0.0008, 0.0010]:
            for beta_scale_rate in [10, 30, 50, 70, 100]:
                for conv1_out_channels in [32, 64, 128]:
                    for conv2_out_channels in [32, 64, 128]:
                        for conv_kernel_size_num in [5, 10, 15, 20, 30]:
                            for pool_kernel_size_num in [2, 3, 4, 5]:
                                for denoise_hidden_size in [32, 64, 128]:
                                    for discriminator_dis_hidden in [32, 64, 128, 256]:
                                        print('######################################################################')
