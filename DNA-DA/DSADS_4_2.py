...
for ReverseLayer_latent_domain_alpha in [0.005, 0.01, 0.03, 0.04, 0.06, 0.5, 0.6]:
    for n_t in [10, 20, 30, 40, 50, 60, 70]:
        for beta_1 in [0.0001, 0.0002, 0.0004, 0.0008, 0.0010, 0.0050, 0.010, 0.020, 0.030, 0.040]:
